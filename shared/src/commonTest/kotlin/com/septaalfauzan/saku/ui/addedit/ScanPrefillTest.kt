...
class ScanPrefillTest {
    ...
    fun fromReceiptMapsKnownFields() {
        ...
        assertEquals("2x Nasi Goreng", prefill.note)
    ...
    fun withPrefillSeedsFormFields() {
        val prefill = ScanPrefill(amount = 25000, merchant = "M", note = "N", occurredAtMillis = 777L)
    ...
    fun withPrefillKeepsTypeAndClearsCategory() {
        val prefill = ScanPrefill(amount = 1, merchant = "", note = "", occurredAtMillis = 0L)
