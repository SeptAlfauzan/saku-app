    ...
    Scaffold(
        ...
        Column(
            ...
            FlowRow(horizontalArrangement = Arrangement.spacedBy(SakuDp.spaceXs)) {
                FilterChip(
                    stringResource(R.string.export_all),
                    state.datePreset == DatePreset.ALL_TIME,
                    onClick = {
                        vm.setDatePreset(DatePreset.ALL_TIME)
                    })
                FilterChip(
                    stringResource(R.string.export_this_month),
                    state.datePreset == DatePreset.THIS_MONTH,
                    onClick = {
                        vm.setDatePreset(DatePreset.THIS_MONTH)
                    })
                FilterChip(
                    stringResource(R.string.export_this_year),
                    state.datePreset == DatePreset.THIS_YEAR,
                    onClick = {
